	...
	<div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
	  ...
	  <!-- Acesso em:-->
		...
		<?php
			...
			$matricula      = $_POST['Matricula'];  // identifica o registro a ser alterado
			$nome    = $_POST['Nome'];
			...
			$sql = "UPDATE Funcionarios SET Nome = '$nome', Sobrenome = '$sobrenome', Fk_Cargo_ID ='$cargo' WHERE Matricula = $matricula";
